    ...
    education: [
        {
            ...
            content: 'Over the course of my studies, I have completed several courses that have equipped me with a ' +
                'diverse range of skills and knowledge. Some of the courses that worth mentioning are the following:' +
                '\n' + 'Firstly, I have taken courses about computer architecture and the basics of the Linux operating' +
                ...
                '\n' + 'In addition, I have also completed a brief introduction to the basics of electronic circuits, ' +
                'which has enabled me to understand the hardware components of computer systems.\n' +
                '\n' + 'Furthermore, I have taken courses about computer programs and essential coding algorithms, ' +
                'which has given me the ability to write efficient and optimized code.\n' +
                '\n' + 'Moreover, I have learned the basics of Object-Oriented Programming (OOP) including aggregation, ' +
                'composition, inheritance, and more, along with an opening to design patterns.\n' +
                '\n' + 'Additionally, I have been initiated to computer graphics using AutoCAD and OpenGL, as well as ' +
                ...
                '\n' + 'Moreover, I have also completed an introduction to programming embedded systems in C, including ' +
                'microcontrollers and Arduino, which has provided me with the skills to program small systems.\n' +
                '\n' + 'I have also completed a course in relational database design and implementation with SQL, which ' +
                'has enabled me to design, create and manage complex databases.\n' +
                '\n' + 'Furthermore, I have an introduction to hardware design, which has equipped me with a ' +
                'comprehensive understanding of how hardware is designed and manufactured.\n' +
                '\n' + 'Lastly, I have completed an introduction to the basics of signals processing, process modeling ' +
        ...
        },
        {
            ...
            content: 'During this time, I worked with algorithms implementations, especially in C++ but also in Java ' +
    ...
    experience: [
        {
            ...
            content: 'Together with a startup company from Canada, I am currently working to gain a deeper ' +
                'understanding of Neural Networks, Recurrent Neural ' +
                'Networks, Deep Learning, and Machine Learning.\n' +
                '\n' + 'My primary research direction is focused on automating global investment management strategies. ' +
                ...
                '\n' + 'In addition, I am actively seeking the best data to achieve maximum accuracy of the deep ' +
        ...
        },
        {
            ...
            content: 'My day-to-day activities include implementing new features using React and Typescript, ensuring ' +
                'that the code quality is top-notch.\n' +
                '\n' + 'I work closely with the development team, consulting them on code optimizations and possible ' +
                ...
                '\n' + 'As part of my job, I review code and feature implementations on both the backend and frontend ' +
                ...
                '\n' + 'I am always on the lookout for bugs, and whenever the need arises, I take the initiative to fix ' +
                ...
                '\n' + 'Currently I am working on a leading VOD application with over 600,000 unique monthly users ' +
