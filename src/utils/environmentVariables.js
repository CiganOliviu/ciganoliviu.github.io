export const gradientWallpaperDark = 'rgba(0, 0, 0, 0.7), rgba(0, 0, 0, 0.7)';
export const gradientWallpaperOpen = 'rgba(0, 0, 0, 0.2), rgba(0, 0, 0, 0.3)';
export const gradientWallpaperClose = 'rgba(0, 0, 0, 0.4), rgba(0, 0, 0, 0.5)';


export const universityTitle = "Part of Tehnical University since 2020!"
export const universityContent = "In 2019, I decided to study at Technical University in Cluj-Napoca. So I did! In the " +
...
export const threeSSTitle = "Part of 3SS since summer of 2021!";
export const threeSSContent = "At the beginning of 2021, I decided to jump into the market and get an internship as " +
    "a software engineer. For five months I was working on my portfolio, I was preparing for interviews, and I was " +
    "searching, and applying for the right positions at the right companies. \n" +
    "After five months, I got my first internship as a Web Application Developer, and after the internship, where I " +
    "contributed to 40% of the application, I got a job as a Software Engineer. \n" +
